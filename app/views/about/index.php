    ...
    <div class="container">
        <div class="container">
            <div class="col-lg-8 bg-dark text-white p-3 rounded mx-auto d-block m-3 text-wrap ">
                ...
                <p class="text-center"><i>" Sebagai sarana edukasi terbuka untuk semua kalangan mengenai Bahasa Pemrogaram WEB dasar dengan pendekatan sesuai kebutuhan Industri Software, dan sebagai bentuk pengabdian untuk masyarakat. "</i></p>
                <hr>
